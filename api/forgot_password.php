...
try {
    ...
    $stmt->execute([$email]);
    if ($stmt->rowCount() === 0) {
        // For security, detailed message: "Email not found"
    ...
    $subject = "Password Reset OTP - MyVastuTool";
        $body = "
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body style='margin: 0; padding: 0; background-color: #f3f4f6; font-family: \"Segoe UI\", Tahoma, Geneva, Verdana, sans-serif;'>
            <table border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1); margin-top: 40px; margin-bottom: 40px;'>
                <!-- Header -->
                <tr>
                    <td align='center' style='padding: 40px 0; background: linear-gradient(135deg, #f97316 0%, #ea580c 100%);'>
                        <h1 style='color: #ffffff; margin: 0; font-size: 28px; font-weight: 700; letter-spacing: 1px;'>MyVastuTool</h1>
                    </td>
                </tr>
                ...
                <tr>
                    <td style='padding: 40px 30px;'>
                        <h2 style='color: #1f2937; margin-top: 0; margin-bottom: 20px; font-size: 22px; text-align: center;'>Password Reset Request</h2>
                        <p style='color: #4b5563; font-size: 16px; line-height: 1.6; margin-bottom: 30px; text-align: center;'>
                            We received a request to reset your password. Use the verification code below to proceed.
                        </p>
                        
                        <div style='text-align: center; margin-bottom: 40px;'>
                            <span style='display: inline-block; background-color: #fff7ed; color: #ea580c; font-size: 32px; font-weight: 800; padding: 15px 30px; border-radius: 8px; border: 2px dashed #f97316; letter-spacing: 5px;'>$otp</span>
                        </div>
                ...
                <tr>
                    <td style='background-color: #f9fafb; padding: 20px; text-align: center; border-top: 1px solid #e5e7eb;'>
                        <p style='color: #9ca3af; font-size: 12px; margin: 0;'>
                            &copy; " . date("Y") . " MyVastuTool. All rights reserved.
                        </p>
                    </td>
                </tr>
            </table>
